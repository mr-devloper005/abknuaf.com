...
export default function AboutPage() {
  return (
    <EditableSiteShell>
      <main className="bg-[#111844] px-4 py-14 text-[#EAE0CF] sm:px-6 lg:px-8">
        <section className="mx-auto grid max-w-[var(--editable-container)] gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <article className="rounded-[2.5rem] border border-[#7288AE]/40 bg-[#EAE0CF] p-8 text-[#111844] shadow-sm lg:p-12">
          ...
          <aside className="space-y-4">
            {pagesContent.about.values.map((value) => (
              <div key={value.title} className="rounded-[2rem] border border-[#7288AE]/40 bg-[#EAE0CF] p-6 text-[#111844] shadow-sm">
