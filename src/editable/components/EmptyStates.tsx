...
export function EmptyState({
  ...
  return (
    <section className={cn('rounded-[2rem] border border-[var(--editable-border)] bg-white p-8 text-center shadow-[0_12px_32px_rgba(16,23,40,0.06)]', className)}>
      ...
      <Link href={actionHref} className="mt-6 inline-flex items-center gap-2 rounded-full bg-[var(--slot4-accent)] px-5 py-3 text-sm font-black text-white transition hover:-translate-y-0.5">
        {actionLabel}
