...
export const taskPageVoices = {
  ...
  classified: { eyebrow: 'Classified board', headline: 'Fast-moving offers with clear action cues.', description: 'Scan active posts in a sharper feed built to surface important details quickly.', filterLabel: 'Filter offer category', secondaryNote: 'Built for speed, trust, and action.', chips: ['Offers', 'Price first', 'Quick contact'] },
